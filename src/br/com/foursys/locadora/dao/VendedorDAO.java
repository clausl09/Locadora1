...
public class VendedorDAO {
	...
	public void inserir(Vendedor vendedor) throws SQLException {
		...
		comando.setString(3, vendedor.getCidade().toString());
		comando.setString(4, vendedor.getEstado().toString());
	...
	public void alterar(Vendedor vendedor) throws SQLException {
		...
		comando.setString(2, vendedor.getCidade().toString());
		comando.setString(3, vendedor.getEstado().toString());
	...
	public List<Vendedor> buscarTodos() throws SQLException {
		...
		while (cursor.next()) {
			...
			vendedor.setSalario(cursor.getInt("Salario"));
